      ...
      <div className="w-full max-w-4xl overflow-hidden rounded-3xl shadow-2xl shadow-[#102737]/20 flex">
        ...
        <div className="w-full md:w-1/2 bg-[#fffaf0] px-8 py-12 flex flex-col justify-center">
          <div className="mb-8 flex flex-col items-center md:items-start">
            ...
            <h1 className="text-2xl font-bold text-[#183247]">Welcome back</h1>
            <p className="mt-1 text-sm text-[#5d6d78]">Sign in to your account</p>
          </div>

          {error && (
            <div
              className={`mb-4 rounded-xl border border-[#e8c5c0] bg-[#fdf0ee] px-4 py-3 text-sm text-[#a84f45] ${shake ? "animate-[shake_0.4s_ease]" : ""}`}
            >
              {error}
            </div>
          )}
          ...
          <p className="mt-6 text-center text-sm text-[#5d6d78]">
            ...
            <Link to="/register" className="font-medium text-[#2f6668] hover:underline">
              Register
            </Link>
          </p>
        </div>
